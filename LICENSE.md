...
This is an all-rights-reserved work. It is **not** open-source, and no open-source
...
Product names, framework names, standards, and links referenced in this work are
the property of their respective owners and are used for identification and
educational purposes only. Their mention does not imply endorsement.

## Contact

For permissions and licensing inquiries, contact bear@bearbrown.co.
