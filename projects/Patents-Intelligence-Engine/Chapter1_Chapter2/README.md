...
- `theses/` — claim-audit tables, one per ticker or thesis under review
- `evidence/` — source documents and data pulls backing specific claims
- `signals/` — options-chain and market-signal data, kept separate from narrative
- `book/` — reference material
- `CANNOT-KNOW.md` — the charter of what no model or market chatter can determine for me
- `CLAUDE.md` — the standing rule governing AI's role in this desk
